...
export const phrases = [
  ...
  'Quero poder beijar tua mão sempre que a segurar, pra te dizer que estou aqui pra ti',
  'Quero que tu me deseje e olhe pra mim como se quisesse me devorar',
  'Tua carinha de sono é encantadora',
  ...
  'Tua presença já alegra o meu dia',
  ...
  'Fico animado para fazermos muitas coisas juntos',
  'Quero massagear teus pés pra te ajudar a relaxar',
  ...
  'Quero ser a tua companhia e teu assistente enquanto cozinhas',
  'Quero te acompanhar nos lugares que gosta',
  ...
  'Tu és delicada, e isso me atrai tanto, desde tuas roupas e maquiagens até teu jeito de falar e escrever',
  'Me encantam teus pensamentos profundos, gosto muito das conversas sérias e complexas que conseguimos ter',
  'Gosto muito do teu charme, ele me encanta muito ',
  'Tu és a mais bela pintura que eu poderia imaginar',
  'Admiro teus ideais e crenças, mesmo quando discordo de algumas coisas',
  'Tens a beleza delicada de uma bela flor',
  'Tua voz é tão aconchegante e agradável',
  'Teu corpo é lindo e de saia faz minha imaginação ficar a mil',
  'Quero quebrar o tédio dos teus dias',
  'Sempre que precisar, terás meu apoio',
  'Vou ser o teu lobo, fiel por toda a vida',
  'Quero que tu sejas sempre a primeira imagem do meu dia',
  'Me sinto realizado por poder ter o privilégio de aproveitar tua presença',
  'Quero conhecer diversos lugares diferentes contigo',
  'Quero que tu sejas sempre a pessoa a ouvir as últimas palavras do meu dia antes de dormir',
  ...
  'Quero fazer tu se sentir amada',
  'Quero aprender e decorar cada parte do teu corpo',
  'Tens sobrancelhas que parecem desenhadas de tão bonitas',
  'Quero que tu te sintas tranquila e à vontade quando estiver comigo, que estar comigo seja um momento de paz no teu dia',
  'Teus lábios são tão atraentes, têm o formato perfeito',
  ...
  'Gosto muito de como tu mudas de assunto com facilidade nas nossas conversas',
  'Fica tão fofa com os olhos entreabertos enquanto está no sol forte',
  ...
  'Tu ficas linda de óculos',
  'Quero te encher de lembranças e presentes pra não se sentir sozinha quando eu não estiver por perto',
  'Me sinto bem contigo',
  'Quero fazer com que tu te sintas uma princesa',
  'Gosto de como sinto que estou sempre melhorando quando tô contigo. Tu me fazes ser melhor',
  'Apesar de eu não saber como reagir, fico sempre bobo e alegre com teus elogios e declarações',
  ...
  'Quero ter muitos cafés da tarde contigo, ainda mais com pão caseiro',
  'Gosto de como me sinto cuidado por ti',
  'Quero construir nossa felicidade juntos',
  ...
  'Gosto muito que nossa altura seja parecida, deixa nossos abraços e beijos perfeitos',
  'Quero acabar com teus estresses enquanto desabafas recebendo meu cafuné',
  'Quero me tornar o teu lar e que tu queiras sempre retornar pra mim',
